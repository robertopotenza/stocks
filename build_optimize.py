...
def print_build_optimizations():
    ...
    print("=" * 60)
    print("1. Use Dockerfile.optimized for fastest builds (~45s, 390MB)")
    ...
    print("- Multi-stage build reduces image size by 32% (572MB → 390MB)")
    print("- Enhanced .dockerignore excludes backup files and docs")
    print("- Specific file copying reduces build context")
    print("- Layer caching optimized for faster rebuilds")
    print("- System dependencies minimized to essentials only")
